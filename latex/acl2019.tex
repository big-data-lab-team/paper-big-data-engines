...
In Figure \ref{fig:inc_chunk} Spark is not compared for 30 chunks. This is because spark has a 2GB limitation in the task size it can compute. All API have a longer make span at 30 chunks compared to 125 chunks. This is because the 8 instances each have 8 cores thus merely half the resources available are used. At 125 chunks Dask bag are the fastest. This could be explained by Dask bag having the better optimization of the Dask's API and that Spark has to perform serialization to Java. At 750 chunks Spark becomes as good 
