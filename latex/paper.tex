...
Once more, Spark is significantly faster then Dask engines and Bag is slightly faster
...
\subsection{Effect of data transfer}

\subsection{Effect of the Global Interpreter Lock}

\subsection{Effect of the number of partitions}
