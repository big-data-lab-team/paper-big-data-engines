...
With the exception of Dask Bags, all APIs, by default, use the local multithreaded
scheduler. Dask Bags instead relies on the local multiprocessing scheduler. 
...
due to Python's GIL preventing Dask to parallelize the computation on multiple thread.
