...
Lustre is a reference file system for HPC environments, used in over 60 of the TOP100 supercomputers~\cite{OpenSFS-lustre}, offering parallel file accesses.
...
and similarities, for HPC, between Dask and Spark for data-intensive applications.
...
While other filesystem such as HDFS or cloud storage could be considered, we chose Lustre to best represent an HPC environment.
...
All of the compute and storage nodes are inter-connected by a \SI{10}{\giga\bit\per\second} Ethernet link through a switch.
...
Our system uses similar hardware as Compute Canada Beluga, and replicates as
...
The scripts used for our experiements and the results generated are available on
GitHub at: \href{https://github.com/mathdugre/paper-big-data-engines}{https://github.com/mathdugre/paper-big-data-engines/}.
...
We used Lustre as shared file system as it is a defacto solution in HPC systems.
...
For our experiments, we allocated all available memory on the compute nodes.
